    ...
    if (!(window.MathJax && MathJax.Hub)) {
        ...
        (function(d) {
            ...
            b.Object = c({constructor: a(),Subclass: function(g, i) {
                    ...
                    return false
                },SimpleSUPER: c({constructor: function(g) {
                        ...
                        delete this.SUPER;
                        return g
                    }.toString().replace(/^\s*function\s*\(\)\s*\{\s*/i, "").replace(/\s*\}\s*$/i, ""),toString: function() {
        ...
        (function(BASENAME) {
            ...
            CALLBACK.prototype = {isCallback: true,hook: function() {
            ...
            var HOOKS = MathJax.Object.Subclass({Init: function(reset) {
                    this.hooks = [];
                    this.reset = reset
        ...
        (function(d) {
            ...
            a.Ajax = {loaded: {},loading: {},loadHooks: {},timeout: 15 * 1000,styleDelay: 1,config: {root: ""},STATUS: {OK: 1,ERROR: -1},rootPattern: new RegExp("^\\[" + d + "\\]"),fileURL: function(h) {
                    ...
                    for (var k = 0, h = arguments.length; k < h; k++) {
                        ...
                        this.loading[i] = {callback: k,timeout: setTimeout(j, this.timeout),status: this.STATUS.OK,script: h};
        ...
        MathJax.HTML = {Element: function(c, e, d) {
            ...
            },Cookie: {prefix: "mjx",expires: 365,Set: function(a, e) {
                    var d = [];
                    if (e) {
                        for (var g in e) {
        ...
        MathJax.Localization = {locale: "en",directory: "[MathJax]/localization",strings: {br: {menuTitle: "brezhoneg"},cdo: {menuTitle: "M\u00ECng-d\u0115\u0324ng-ng\u1E73\u0304"},cs: {menuTitle: "\u010Desky"},da: {menuTitle: "dansk"},de: {menuTitle: "Deutsch"},en: {menuTitle: "English",isLoaded: true},eo: {menuTitle: "Esperanto"},es: {menuTitle: "espa\u00F1ol"},fa: {menuTitle: "\u0641\u0627\u0631\u0633\u06CC"},fi: {menuTitle: "suomi"},fr: {menuTitle: "fran\u00E7ais"},gl: {menuTitle: "galego"},he: {menuTitle: "\u05E2\u05D1\u05E8\u05D9\u05EA"},ia: {menuTitle: "interlingua"},it: {menuTitle: "italiano"},ja: {menuTitle: "\u65E5\u672C\u8A9E"},ko: {menuTitle: "\uD55C\uAD6D\uC5B4"},lb: {menuTitle: "L\u00EBtzebuergesch"},mk: {menuTitle: "\u043C\u0430\u043A\u0435\u0434\u043E\u043D\u0441\u043A\u0438"},nl: {menuTitle: "Nederlands"},oc: {menuTitle: "occitan"},pl: {menuTitle: "polski"},"pt-br": {menuTitle: "portugu\u00EAs do Brasil"},pt: {menuTitle: "portugus\u00EA"},ru: {menuTitle: "\u0440\u0443\u0441\u0441\u043A\u0438\u0439"},sl: {menuTitle: "sloven\u0161\u010Dina"},sv: {menuTitle: "svenska"},tr: {menuTitle: "T\u00FCrk\u00E7e"},uk: {menuTitle: "\u0443\u043A\u0440\u0430\u0457\u043D\u0441\u044C\u043A\u0430"},"zh-hans": {menuTitle: "\u4E2D\u6587\uFF08\u7B80\u4F53\uFF09"}},pattern: /%(\d+|\{\d+\}|\{[a-z]+:\%\d+(?:\|(?:%\{\d+\}|%.|[^\}])*)+\}|.)/g,SPLIT: ("axb".split(/(x)/).length === 3 ? function(a, b) {
                ...
                return c
            },markdownPattern: /(%.)|(\*{1,3})((?:%.|.)+?)\2|(`+)((?:%.|.)+?)\4|\[((?:%.|.)+?)\]\(([^\s\)]+)\)/,processMarkdown: function(b, h, d) {
                var j = [], e;
        ...
        MathJax.Message = {ready: false,log: [{}],current: null,textNodeBug: (navigator.vendor === "Apple Computer, Inc." && typeof navigator.vendorSub === "undefined") || (window.hasOwnProperty && window.hasOwnProperty("konqueror")),styles: {"#MathJax_Message": {position: "fixed",left: "1px",bottom: "2px","background-color": "#E6E6E6",border: "1px solid #959595",margin: "0px",padding: "2px 8px","z-index": "102",color: "black","font-size": "80%",width: "auto","white-space": "nowrap"},"#MathJax_MSIE_Frame": {position: "absolute",top: 0,left: 0,width: "0px","z-index": 101,border: "0px",margin: "0px",padding: "0px"}},browsers: {MSIE: function(a) {
        ...
        MathJax.Hub = {config: {root: "",config: [],styleSheets: [],styles: {".MathJax_Preview": {color: "#888"}},jax: [],extensions: [],preJax: null,postJax: null,displayAlign: "center",displayIndent: "0",preRemoveClass: "MathJax_Preview",showProcessingMessages: true,messageStyle: "normal",delayStartupUntil: "none",skipStartupTypeset: false,elements: [],positionToHash: true,showMathMenu: true,showMathMenuMSIE: true,menuSettings: {zoom: "None",CTRL: false,ALT: false,CMD: false,Shift: false,discoverable: false,zscale: "200%",renderer: "",font: "Auto",context: "MathJax",locale: "en",mpContext: false,mpMouse: false,texHints: true},errorSettings: {message: ["[", ["MathProcessingError", "Math Processing Error"], "]"],style: {color: "#CC0000","font-style": "italic"}}},preProcessors: MathJax.Callback.Hooks(true),inputJax: {},outputJax: {order: {}},processUpdateTime: 250,processUpdateDelay: 10,signal: MathJax.Callback.Signal("Hub"),Config: function(a) {
                ...
                return b
            },Register: {PreProcessor: function() {
                ...
                return b.Push(c.callback)
            },scriptAction: {Process: function(a) {
                },Update: function(b) {
        ...
        MathJax.Hub.Startup = {script: "",queue: MathJax.Callback.Queue(),signal: MathJax.Callback.Signal("Startup"),params: {},Config: function() {
        ...
        (function(d) {
            ...
            var g = MathJax.Object.Subclass({JAXFILE: "jax.js",require: null,config: {},Init: function(i, h) {
                ...
                }}, {id: "Jax",version: "2.3",directory: e + "/jax",extensionDir: e + "/extensions"});
            b.InputJax = g.Subclass({elementJax: "mml",sourceMenuTitle: ["Original", "Original Form"],copyTranslate: true,Process: function(l, q) {
                    ...
                    c.inputJax[h] = this
                }}, {id: "InputJax",version: "2.3",directory: g.directory + "/input",extensionDir: g.extensionDir});
            b.OutputJax = g.Subclass({copyTranslate: true,preProcess: function(j) {
                ...
                }}, {id: "OutputJax",version: "2.3",directory: g.directory + "/output",extensionDir: g.extensionDir,fontDir: e + (b.isPacked ? "" : "/..") + "/fonts",imageDir: e + (b.isPacked ? "" : "/..") + "/images"});
            b.ElementJax = g.Subclass({Init: function(i, h) {
                    return this.constructor.Subclass(i, h)
                },inputJax: null,outputJax: null,inputID: null,originalText: "",mimeType: "",sourceMenuTitle: ["MathMLcode", "MathML Code"],Text: function(i, j) {
                ...
                }}, {id: "ElementJax",version: "2.3",directory: g.directory + "/element",extensionDir: g.extensionDir,ID: 0,STATE: {PENDING: 1,PROCESSED: 2,UPDATE: 3,OUTPUT: 4},GetID: function() {
                    this.ID++;
            ...
            b.OutputJax.Error = {id: "Error",version: "2.3",config: {},ContextMenu: function() {
                    ...
                    return {inputJax: (h || {id: "Error"}).id,outputJax: "Error",sourceMenuTitle: ["ErrorMessage", "Error Message"],sourceMenuFormat: "Error",originalText: MathJax.HTML.getScript(i),errorText: j}
                }};
            b.InputJax.Error = {id: "Error",version: "2.3",config: {},sourceMenuTitle: ["Original", "Original Form"]}
        })("MathJax");
        (function(l) {
            var f = window[l];
            if (!f) {
            ...
            for (var o = b.length - 1; o >= 0; o--) {
                if ((b[o].src || "").match(d)) {
                    ...
                    u.root = b[o].src.replace(/(^|\/)[^\/]*(\?.*)?$/, "").replace(/^(https?:\/\/(cdn.mathjax.org|c328740.ssl.cf1.rackcdn.com)\/mathjax\/)(latest)/, "$1" + f.version + "-$3");
                    break
                }
            }
            f.Ajax.config = u;
            ...
            if (f.AuthorConfig && typeof f.AuthorConfig.AuthorInit === "function") {
                f.AuthorConfig.AuthorInit()
            }
